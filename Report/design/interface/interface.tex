...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        \centering\includegraphics[width = \textwidth]{design/ui/profile}
        \caption{Node Profile}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering\includegraphics[width = \textwidth]{design/ui/count_plot.png}
        \caption{Vehicle Volume Plot}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering\includegraphics[width = \textwidth]{design/ui/whole_page.png}
